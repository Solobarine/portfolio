const Contact = () => {
  return (
    <div className="bg-zinc-200 py-20 p-4" id="contact">
      <h1 className="text-3xl sm:text-5xl font-semibold text-center mb-10 text-gray-800">
        Contact Me
      </h1>
      <div className="flex flex-wrap justify-center gap-10">
          ...
          <div className="py-6 border-t border-gray-300 mt-6">
            ...
            <div className="flex flex-col space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-lg text-gray-600 hover:text-emerald-600 transition-all duration-300 ease-in-out"
              >
        ...
        <div className="w-full max-w-[30em] bg-white shadow-lg p-8 rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800 mb-4">
            Send me a message
          </h3>
