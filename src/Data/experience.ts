const experience = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Conducted market and user research, identifying user trust and brand preference for existing players (Opay, Moniepoint).",
      "Operated the startup part-time while working as an independent contractor, balancing product development and client commitments.",
      "Gained valuable insights into fintech market saturation, user acquisition challenges, and monetization strategies.",
    ],
  },
  {
    id: 2,
