...
const NavBar = () => {
  ...
  return (
    <div className='sticky top-0 z-40 flex items-center justify-between p-2 bg-emerald-300'>
      ...
      <div
        className={`flex flex-col fixed bg-gray-300 z-50 p-2 top-0 right-0 transition-all duration-500 ease-in h-screen bottom-0 w-56 lg:flex-row gap-4 ${
      ...
      >
        ...
        <a
          ...
          onClick={toggle}
        >
          <i className='fa-solid fa-building-columns'></i> Education
        </a>
